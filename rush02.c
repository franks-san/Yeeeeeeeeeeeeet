...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/07/21 01:12:03 by frlefebv          #+#    #+#             */
/*   Updated: 2019/07/21 03:23:30 by frlefebv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char **ft_split(char *str, char *charset)
{
	...
	while (str[++k] != '\0')
	{
		...
		{	
			if (k == 0 || check_world(str[k], str[k - 1], charset))
			{
	...
	arr[get_word_count(str, charset)] = 0;
	return (arr);
}
...
int main()
{
	...
	i = 0;
	str = "zero une due tre quattro cinque sei sette otto nove dieci";
	charset = " ";
